...
//2nd approach using states method:
class Solution {
public:
    int maxProfit(vector<int>& prices) {
        int n = prices.size();
...
result is maximum of both the cases
1) nostock---> a)nostock b)sold
2)inhand--------> a)inhand b) nostock-price[today]
3)sold---->inhand+price[today]
